...
const observer = new MutationObserver(() => {
	const slider = document.querySelector('.choose-active');
	if (slider) {
	  console.log(".choose-active found!");
	  observer.disconnect();
	  initializeSlider();
	}
  });
...
const observer2 = new MutationObserver(() => {
	const element = document.querySelector('.bt-roadmap_x');
	if (element) {
		console.log('.bt-roadmap_x found!');
